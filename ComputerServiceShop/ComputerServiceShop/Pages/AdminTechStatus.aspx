<%@ Page Title="" Language="C#" MasterPageFile="~/Masterpage.Master" AutoEventWireup="true" CodeBehind="AdminTechStatus.aspx.cs" Inherits="ComputerServiceShop.Pages.AdminTechStatus" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="Id" DataSourceID="SqlDataSource1" EmptyDataText="There are no data records to display." BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Horizontal" >
        <Columns>
            ...
            <asp:TemplateField HeaderText="Re-Password" SortExpression="RePassword">
                ...
                <ItemTemplate>
                    <asp:Label ID="Label4" runat="server" Text='<%# Bind("RePassword") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
